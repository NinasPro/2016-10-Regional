...
\begin{scoreDescription}
  ...
  \score{10} Se probarán casos donde $1 \leq N \leq 100$, $1\leq k_i \leq 1000$ para cada $i$. Además, existe un $m \leq n$ tal que para cada $i < m$, se tiene que $c_i = 1$, y para cada $i \geq m$ se tiene $c_i = 0$. Ver ejemplo 2.
