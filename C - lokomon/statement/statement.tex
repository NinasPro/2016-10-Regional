...
% Entrega el Lokómon que maximice la suma de valores por sobre todos los vecinos. Es decir, $j$ tal que el valor $V_{j} := \sum_{i = 1}^{M}v_{i,j}$ sea máximo.
...
%  LocalWords:  lokómones Olonsonder Pijorgechú Nelmanpuff lokómon
